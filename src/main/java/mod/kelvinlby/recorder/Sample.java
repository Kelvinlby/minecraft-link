...
/**
 * One aligned dataset sample: a packed RGBD frame and the action set observed at the same clock
 * tick, stamped with a monotonic sequence number and a wall-clock timestamp. Produced by
 * {@link Sampler} on its fixed clock and drained by {@link DatasetWriter}.
 *
